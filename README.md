...
> **[v1.0.0-dev.1](https://github.com/ImmortalZeus/ImmortalZeus-Morphe-Patches/releases/tag/v1.0.0-dev.1)**&nbsp;&nbsp;•&nbsp;&nbsp;`dev`&nbsp;&nbsp;•&nbsp;&nbsp;2 patches total
<details open>
...
| 💊&nbsp;Patch | 📜&nbsp;Description | ⚙️&nbsp;Options |
|----------|----------------|-----------|
| [Block hosts in string resources](#block-hosts-in-string-resources) | Blocks ads and trackers by replacing hosts in XML string resources. Works alongside bytecode hosts blocker for comprehensive coverage. | • Hosts file<br>• Redirection IP<br>• Wildcard blocking |
